              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-6">
                {globalAnimeList
                  ...
                  .map((anime, idx) => {
                    ...
                    return (
                      <div key={`pv-${anime.id || 'anime'}-${idx}`} className="flex items-center justify-between p-4 bg-[#050505]/30 border border-white/5 rounded-xl hover:border-white/10 transition-all">
